<section class="section section-sm section-last bg-default">
    <div class="container">
        ...
        <div class="row row-60 row-sm">
            <div class="col-sm-6 col-lg-4 wow fadeInLeft" style="visibility: hidden; animation-name: none;">
                <!-- Post Modern-->
                <article class="post post-modern">
                    <a class="post-modern-figure" href="#">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/custom_assets/images/post-10-370x307.jpg" alt="" width="370" height="307">
            ...
            <div class="col-sm-6 col-lg-4 wow fadeInLeft" data-wow-delay=".1s" style="visibility: hidden; animation-delay: 0.1s; animation-name: none;">
                <!-- Post Modern-->
                <article class="post post-modern">
                    <a class="post-modern-figure" href="#">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/custom_assets/images/post-11-370x307.jpg" alt="" width="370" height="307">
                        <div class="post-modern-time">
            ...
            <div class="col-sm-6 col-lg-4 wow fadeInLeft" data-wow-delay=".2s" style="visibility: hidden; animation-delay: 0.2s; animation-name: none;">
                <!-- Post Modern-->
                <article class="post post-modern">
                    <a class="post-modern-figure" href="#">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/custom_assets/images/post-12-370x307.jpg" alt="" width="370" height="307">
                        <div class="post-modern-time">
                            <time datetime="2019-07-22"><span class="post-modern-time-month">07</span><span class="post-modern-time-number">22</span></time>
                        </div>
                    </a>
                    <h4 class="post-modern-title"><a href="#">Hibernate Query Language</a></h4>
